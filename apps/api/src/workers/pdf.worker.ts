...
export class PdfWorker {
  ...
  private drawFeeReceipt(doc: PDFKit.PDFDocument, payload: PdfJobPayload): void {
    ...
    const coachingName = String(meta.coachingName || 'Vargly Partner Institute');
    ...
    doc.text('This is an electronically generated receipt verified by Vargly Coaching ERP.', 50, doc.y, { align: 'center' });
  ...
  private drawStudentReport(doc: PDFKit.PDFDocument, payload: PdfJobPayload): void {
    ...
    doc.fontSize(8).fillColor('#94A3B8').text('Generated by Vargly Education Analytics Engine.', { align: 'center' });
  }
  ...
  private drawSalarySlip(doc: PDFKit.PDFDocument, payload: PdfJobPayload): void {
    ...
    doc.fontSize(18).font('Helvetica-Bold').text('Vargly Faculty Salary Slip', { align: 'center' });
  ...
  private drawGenericDocument(doc: PDFKit.PDFDocument, payload: PdfJobPayload): void {
    doc.fontSize(16).font('Helvetica-Bold').text(`Vargly Document - ${payload.type}`, { align: 'center' });
    doc.moveDown(1);
